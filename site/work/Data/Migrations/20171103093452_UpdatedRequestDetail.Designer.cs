...
namespace QFlow.Migrations
{
    ...
    [Migration("20171103093452_UpdatedRequestDetail")]
    partial class UpdatedRequestDetail
    {
            ...
            modelBuilder.Entity("QFlow.Models.DataModels.Request", b =>
                {
                    ...
                    b.HasOne("QFlow.Models.DataModels.RequestDetail", "Detail")
                        .WithOne("Request")
                        .HasForeignKey("QFlow.Models.DataModels.Request", "DetailId")
                        .OnDelete(DeleteBehavior.Cascade);
