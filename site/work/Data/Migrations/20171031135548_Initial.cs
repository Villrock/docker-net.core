        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedQty = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            string insert = @"insert RequestStatuses(id, name)values({0}, '{1}')";
            migrationBuilder.Sql(string.Format(insert, "10", "New"));
            migrationBuilder.Sql(string.Format(insert, "20", "Quoting"));
            migrationBuilder.Sql(string.Format(insert, "30", "Purchasing"));
            migrationBuilder.Sql(string.Format(insert, "40", "Invoiced"));
            migrationBuilder.Sql(string.Format(insert, "50", "Paid"));
            migrationBuilder.Sql(string.Format(insert, "60", "Closed"));
            migrationBuilder.Sql(string.Format(insert, "999", "Canceled"));
